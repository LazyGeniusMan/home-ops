...
**Always consult the [Talos](https://docs.siderolabs.com/talos/v1.14/overview/what-is-talos) and [Omni](https://docs.siderolabs.com/omni/getting-started/getting-started) docs for configuration, latest features and best practices**
...
Download the right Talos Linux image for your operating system from the [Image factory](references/image-factory.md).
...
Additionally, refer to the [Talos for Linux Admins](https://docs.siderolabs.com/talos/v1.14/learn-more/talos-for-linux-admins) to learn about the Talos alternative for Linux commands.
